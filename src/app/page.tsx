...
import { CheckCircle, Leaf, Package, Shield, Zap, TrendingUp, ArrowRight } from "lucide-react";
...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#1a1c1f]">
      <ScrollToTop smooth color="#2081e2" style={{ display: "flex", justifyContent: "center", alignItems: "center", background: "#262b2f", border: "1px solid #353840" }} />
          ...
          <div className="relative py-24 flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-[#8a939b] text-lg mb-8 max-w-lg">
                Buy, sell, and trade digital collectibles on the Ronin blockchain.
                Join a growing community of collectors and creators building the
                next generation of digital ownership.
              </p>
            ...
            <div className="flex-1 grid grid-cols-2 gap-4 max-w-sm w-full">
              {platformStats.map((stat) => (
                <div key={stat.label} className="bg-[#262b2f] border border-[#353840] rounded-xl p-4 text-center">
                  <div className="text-white text-2xl font-bold">{stat.value}</div>
                  <div className="text-[#8a939b] text-sm mt-1">{stat.label}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="border-b border-[#21262d]">
        <MaxWidthWrapper className="py-20">
          <div className="text-center mb-12">
            <h2 className="text-white text-3xl font-bold mb-3">Why CryptoRonin?</h2>
            <p className="text-[#8a939b] max-w-xl mx-auto">
              Everything you need to trade, collect, and grow your digital assets on the Ronin blockchain.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-[#8a939b] mb-6">
                Token distribution breakdown. Purchase tokens during the sale to get the best allocation rates.
              </p>
              ...
              <div className="bg-[#262b2f] border border-[#353840] rounded-xl p-4">
                <p className="text-[#8a939b] text-sm mb-2">Token Sale ends in:</p>
                <Countdown />
              </div>
            </div>
      ...
      <section className="border-b border-[#21262d]">
        <MaxWidthWrapper className="py-20">
          <h2 className="text-white text-2xl font-bold text-center mb-10">Our Team</h2>
          <div className="flex justify-center">
            <div className="bg-[#262b2f] border border-[#353840] rounded-xl p-6 text-center w-48 hover:border-[#2081e2]/40 transition-colors">
              <Avatar className="block mx-auto mb-3">
                <AvatarImage src="https://github.com/shadcn.png" className="w-16 h-16 rounded-full" />
                <AvatarFallback className="w-16 h-16 rounded-full bg-[#2081e2]/20 text-[#2081e2] font-bold flex items-center justify-center">AO</AvatarFallback>
              </Avatar>
      ...
      <section>
        <MaxWidthWrapper className="py-20 max-w-2xl">
          <h2 className="text-white text-2xl font-bold text-center mb-10">FAQ</h2>
          <Accordion type="single" collapsible className="space-y-3">
            <AccordionItem value="item-1" className="bg-[#262b2f] border border-[#353840] rounded-xl px-5 data-[state=open]:border-[#2081e2]/40">
              ...
              <AccordionContent className="text-[#8a939b] pb-4">
                Click &quot;Connect Wallet&quot; in the top navigation bar. If you don&apos;t have
                the Ronin wallet extension installed, you&apos;ll be redirected to download it first.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-2" className="bg-[#262b2f] border border-[#353840] rounded-xl px-5 data-[state=open]:border-[#2081e2]/40">
              <AccordionTrigger className="text-white hover:no-underline py-4">
                What are the token sale allocation rates?
              </AccordionTrigger>
              <AccordionContent className="text-[#8a939b] pb-4">
                Token allocations are split across Financial Overhead (73%), Bonus &amp; Fund (55%),
                IT Infrastructure (38%), and Gift Code Inventory (20.93%). Early participants receive the best rates.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-3" className="bg-[#262b2f] border border-[#353840] rounded-xl px-5 data-[state=open]:border-[#2081e2]/40">
              <AccordionTrigger className="text-white hover:no-underline py-4">
                When can I start minting NFTs?
              </AccordionTrigger>
              <AccordionContent className="text-[#8a939b] pb-4">
                NFT minting is available now. Connect your Ronin wallet, browse the collection,
                and mint directly from the Collection page.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </MaxWidthWrapper>
