    ...
    <div className="card-lift group relative rounded-xl overflow-hidden bg-card border border-border hover:border-primary/50 hover:shadow-xl hover:shadow-primary/10 cursor-pointer">
      ...
      <div className="relative overflow-hidden aspect-square bg-background">
        ...
        <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex items-end justify-center pb-4">
          <button className="btn-press bg-primary hover:bg-primary/80 text-white px-6 py-2.5 rounded-xl text-sm font-medium translate-y-2 group-hover:translate-y-0 transition-transform duration-200">
            Buy Now
          </button>
        </div>
      </div>
      ...
      <div className="p-3">
        ...
        <div className="flex items-center justify-between mt-2">
          ...
          <button className="heart-like text-muted-foreground hover:text-destructive p-1.5 -mr-1 rounded-lg hover:bg-destructive/10 transition-colors duration-200">
